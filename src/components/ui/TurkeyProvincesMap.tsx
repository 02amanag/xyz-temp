...
export default function TurkeyProvincesMap({
  ...
  const [geoData, setGeoData] = useState<any>();   // harita GeoJSON’u
  ...
  /* -------- UI -------- */
  if (loading) return <>Harita yükleniyor…</>;
  ...
  return (
    <ReactECharts
      ...
      onEvents={onEvents}
      notMerge={false}        // ← artık yeniden yaratmaz
      lazyUpdate              // ← diff ederek günceller
    />
  );
}
