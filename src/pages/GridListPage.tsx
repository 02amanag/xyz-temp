...
import { Card, CardContent, CardDescription, CardHeader, CardTitle, List, Label, GridList, Tabs, TabsList } from "xyz-comp";
      ...
      {selectedTab === 'list' ?
        ...
        (
          <GridList
            ...
            isItemDisabled={(item) => item.email === "Jayne_Kuhic@sydney.com"}
            loading={loading}
            // xl ise 4 lg ise 3 lg altında ise 1 yani tüm satırı kapsar
